export const modelsData = [
  ...
  },
  {
    ...
    capabilities: ["streaming", "reasoning", "chat", "vision", "image_generation"],
    pricing: {
      text_tokens: {
        standard: {
          input_per_million: 0.3,
  ...
  },
  {
    ...
    capabilities: ["streaming", "chat", "speech_generation"],
    pricing: {
      text_tokens: {
        standard: {
  ...
  },
  {
    ...
    capabilities: ["streaming", "chat", "vision", "transcription"],
    pricing: {
      text_tokens: {
        standard: {
          input_per_million: 0,
  ...
  },
  {
    ...
    capabilities: ["streaming", "reasoning", "chat", "vision"],
    pricing: {
      text_tokens: {
        standard: {
          input_per_million: 1.25,
  ...
  },
  {
    ...
    capabilities: ["streaming", "chat", "vision"],
    pricing: {
      text_tokens: {
        standard: {
          input_per_million: 0,
