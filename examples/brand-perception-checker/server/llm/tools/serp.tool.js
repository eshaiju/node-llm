      ...
      organic: [
        {
          ...
          link: "https://docs.example.com/nodellm",
          snippet: "Official guide to getting started with the library."
        },
        {
          title: "Top 10 AI Frameworks in 2026",
          link: "https://techblog.example.com/trends",
          snippet: `Why ${brandName} is climbing the ranks.`
        },
        {
          title: "Securing Node.js LLM Applications",
          link: "https://security.example.com/ai-safety",
          snippet: `Best practices for ${brandName} developers.`
        }
      ]
    };
  }
