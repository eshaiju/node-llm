...
async function main() {
  ...
  const chat3 = llm.chat("gpt-4o-mini").withTool(WeatherTool);
  ...
  const chat5 = llm.chat("gpt-4o-mini").withTool(CalculatorTool);
  ...
  const chat6 = llm.chat("gpt-4o-mini").withTool(WeatherTool);
