...
export const MarketSchema = z.object({
  ...
  market_presence: z
    .enum(["dominant", "strong", "average", "niche"])
    .describe("Relative position in the ecosystem"),
  ...
  competitor_proximity: z
    .array(z.string())
    .describe("Competitors appearing frequently in the same context"),
    ...
    .array(
      z.object({
        ...
        source: z
          .string()
          .describe(
            "The publisher or website name (e.g. Reddit, News18). Derive from URL if needed."
          )
      })
    )
